...
int main()
{
    ...
    while (1)
    {
        ...
        case 3:
			...
			switch (choice3)
			{
			case 1:money = money - price[0];sale = goodsnum[0];printf("You have pressed button A.\n");
				if (money < goodsnum[0])
				{
					printf("invalid choice\n");
				}
				break;
			case 2:money = money - price[1];sale = goodsnum[1];printf("You have pressed button B.\n");
				if (money < goodsnum[1])
				{
					printf("invalid choice\n");
				}
				break;
			case 3:money = money - price[2];sale = goodsnum[2];printf("You have pressed button C.\n");
				if (money < goodsnum[2])
				{
					printf("invalid choice\n");
				}
				break;
			case 4:money = money - price[3];sale = goodsnum[3];printf("You have pressed button D.\n");
				if (money < goodsnum[3])
				{
					printf("invalid choice\n");
				}
				break;
			case 5:money = money - price[4];sale = goodsnum[4];printf("You have pressed button E.\n");
				if (money < goodsnum[4])
				{
					printf("invalid choice\n");
				}
